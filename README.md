...
This go library that helps you generate self signed certificates. It will
...
This library modifies `crypto/tls/generate_cert.go` slightly:
...
```
Calling `generate-tls-cert` will give you nine files. Three of them are the
most important:
